...
CREATE TABLE `BOARD` (
  ...
  `redPlayer` varchar(7) DEFAULT NULL,
  `bluePlayer` varchar(7) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `GAME` (
  ...
  `boardStr` text,
  `lastMoveRed` varchar(30) DEFAULT NULL,
  `lastMoveBlue` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`gameID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-06-02 13:39:58
